...
const Home = () => {
  ...
  return (
    <div className='h-100'>
      <Layout>
      <div className='home'>
        <HomePage isLoading={isLoading} setCurrentSelectedWorkout={setCurrentSelectedWorkout} />
      </div>
      <WorkoutSkeleton isLoading={isLoading} />
      <WorkoutModal setCurrentSelectedWorkout={setCurrentSelectedWorkout} isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen} currentSelectedWorkout={currentSelectedWorkout} />
